...
<head>
    ...
    <script src="https://use.fontawesome.com/b7cb6c081b.js"></script>        <title>Barkane</title>
</head>
<body>
    <?php
       ...
       while($site = $recupSite->fetch()){
           ...
           ?>
                ...
                <input src="<?php echo "./images/".$site['image'];?>"  type="image" data-id='<?php echo $site['id'];?>'  class="presentacion"></input>
                    ...
                    <h5 class='newsCaption-title text-white m-0'><a class="carte hypeb" href="<?php echo $site['url'];?>"><?php echo $site['nom'];?></a> </h5><i class="fas fa-arrow-alt-circle-right "></i>
                    </div>
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            Ce site est bien
                ...
                <div class="text-end">
                <a class="perso mdl" href="#" data-id="1">
                admin
                </a>
                </div>
                </div>
